document.addEventListener('DOMContentLoaded', function() {
    ...
    function drawPatternToCanvas(sequence, stitchesPerRow, stitchType, showGridlines, repeatLength, repeatCount, gridlineInterval) {
      ...
      function drawMajorGridlines(interval) {
        ...
        // Vertical lines (use effectiveStitches)
        for (let i = interval; i < effectiveStitches; i += interval) {
        ...
        // Horizontal lines
        for (let i = interval; i < (canvas.height - topOffset) / stitchHeight; i += interval) {
